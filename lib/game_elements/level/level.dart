...
sealed class Level extends ComplexGlobalGameObject {
  ...
  Level.fromPoints(
      ...
      : this._(pivot, _pointsToTiles(pivot, points, depth, circlular), depth,
            circlular);
  ...
  static List<LevelTile> _pointsToTiles(Positionable pivot,
      List<Positionable> points, double depth, bool circlular) {

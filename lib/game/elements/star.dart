...
import 'package:chromatic_chasm/game/helpers/angle_generator.dart';
import 'package:chromatic_chasm/game/helpers/positionable_generator.dart';
...
class Star extends StatelessGlobalGameObject {
  ...
  void onFrame(Canvas canvas, Camera camera, DateTime frameTimestamp) {
    if (lifecycleState.runtimeType == FlyingLifecycle) {
      pivot.setFrom(
        (lifecycleState as FlyingLifecycle).getCurrentPosition(frameTimestamp),
      );
    }

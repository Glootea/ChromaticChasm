...
typedef TransitionFunction = Positionable Function(
  double timeFraction,
  Positionable startPivot,
  Positionable targetPivot, {
  Positionable? anchorPivot,
});

class TransitionFunctions {
  static Positionable getDefaultAnchorPoint(
    Positionable startPivot,
    Positionable targetPivot,
  ) =>
      PositionFunctions.median(startPivot, targetPivot);

  static Positionable bezierCurve(
    double timeFraction,
    Positionable startPivot,
    Positionable targetPivot, {
    Positionable? anchorPivot,
